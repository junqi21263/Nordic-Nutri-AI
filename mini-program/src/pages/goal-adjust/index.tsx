...
import { createHealthGoalRepository, type AppGoalType, type HealthGoalRepositoryClient } from "../../repositories/health-goal-repository";
import { selectRuntimeAdapter } from "../../repositories/runtime-adapter";
import { useFeedbackStore } from "../../stores/feedback-store";
import { useProfileStore } from "../../stores/profile-store";
import { navigateBackOrHome } from "../../utils/navigation";

const goalTypeByLabel: Record<string, AppGoalType> = {
  "精益增肌": "muscle_gain",
  "轻盈减脂": "fat_loss",
  "保持状态": "maintenance",
};
  ...
  const save = async () => {
    ...
    try {
      if (selectRuntimeAdapter(getPublicRuntimeConfig()) === "supabase") {
        ...
        await createHealthGoalRepository(getSupabaseClient() as unknown as HealthGoalRepositoryClient).saveVersion(auth.user.id, {
