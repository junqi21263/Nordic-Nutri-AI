    ...
    >
      <View className="food-catalog-page">
        <View className="food-catalog-page__title-row">
          <View
            className="food-catalog-page__back"
            ariaLabel="返回"
            onClick={() => navigateBackOrHome("/pages/home/index")}
          >
            <NordicIcon name="back" size={22} ariaLabel="返回" />
          </View>
          <Text>食物库</Text>
        </View>
        <Text className="food-catalog-page__description">
          查询 USDA 标准营养数据，查看食物详情与每 100g 营养估算。
        </Text>
        ...
        <View
          className="food-catalog-filter-summary"
          onClick={() => setFiltersExpanded((value) => !value)}
        >
          <View>
            <Text className="food-catalog-filter-summary__eyebrow">精准筛选</Text>
            <Text className="food-catalog-filter-summary__value">
              {categoryFilter === "全部" && tagFilter === "全部"
                ? "全部食物"
                : [categoryFilter, tagFilter].filter((item) => item !== "全部").join(" · ")}
            </Text>
          </View>
          <Text className="food-catalog-filter-summary__action">
        ...
        {filtersExpanded ? (
          <View className="food-catalog-filters">
            <View className="food-catalog-filters__group">
              <View className="food-catalog-filters__heading">
                <Text className="food-catalog-filters__label">分类</Text>
                <Text>选择一种食物类型</Text>
              </View>
              <ScrollView className="food-catalog-filters__scroll" scrollX>
        ...
        {items.length ? (
          <>
            {!hasSearched ? (
              <Text className="food-catalog-page__discovery-title">今日随机推荐 10 种食物</Text>
            ) : null}
          ...
          <View className="food-catalog-empty">
            ...
            <Text className="food-catalog-empty__copy">
              也可搜索：牛肉、鸡胸肉、salmon、greek yogurt。
            </Text>
          </View>
        )}
      </View>
