...
export const dietaryPatternOptions: DietaryPatternOption[] = [
  { value: "none", label: "无特殊", description: "均衡饮食" },
  { value: "vegetarian", label: "素食为主", description: "优先植物蛋白" },
  { value: "vegan", label: "纯素饮食", description: "不含动物性食物" },
  { value: "pescatarian", label: "鱼素饮食", description: "以鱼类与植物为主" },
  { value: "low_carb", label: "低碳饮食", description: "适度控制碳水" },
  { value: "keto", label: "生酮饮食", description: "高脂低碳结构" },
  { value: "mediterranean", label: "地中海饮食", description: "橄榄油与全谷物" },
  { value: "halal", label: "清真饮食", description: "遵循清真饮食习惯" },
];
