...
| 审核测试微信号 | OWNER CONFIRMED — `junqi21263` 已加入; SCREENSHOT/PLATFORM READBACK PENDING | 负责人已确认该账号已加入体验版/审核成员；仍需留存平台成员回读并完成登录、隐私授权、扫描、保存和注销路径验收；不记录其密码、Token 或 OpenID |
