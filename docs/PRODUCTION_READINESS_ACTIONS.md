...
- 本地已新增 forward-only migration `0051_vision_quota_expiry_reconcile.sql`、readback、rollback 说明和 3/3 静态契约测试；当前机器无可用 PostgreSQL/Docker，因此真实 PG up/readback 尚未验证，0051 不得直接生产执行。
