...
test("explicit tea leaves stay tea_leaf while finished tea drinks stay beverage_liquid", () => {
  const cases = [
    ...
    [{ nameZh: "柠檬水浓缩液", nameEn: "lemonade concentrate" }, "beverage_liquid"],
    [{ nameZh: "橙味早餐饮料浓缩液（含果肉）", nameEn: "orange breakfast beverage concentrate" }, "beverage_liquid"],
    [{ nameZh: "柠檬水粉" }, "drink_powder"],
