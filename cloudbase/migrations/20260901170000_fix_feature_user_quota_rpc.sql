-- Fix the feature quota RPC's PL/pgSQL output-column ambiguity.
-- The original function's unaliased RETURN QUERY columns conflict with the
-- OUT parameter named window_started_at on CloudBase PostgreSQL.
